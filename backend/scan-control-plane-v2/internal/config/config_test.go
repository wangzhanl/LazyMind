...
func TestLoadConfigFromEnv(t *testing.T) {
	t.Setenv("SCAN_CONTROL_PLANE_DB_DSN", "postgres://scan-control-plane")
	t.Setenv("SCAN_CONTROL_PLANE_CORE_BASE_URL", "http://core.test")
	t.Setenv("SCAN_CONTROL_PLANE_DEFAULT_DATASET_ALGO_ID", "custom_algo")
	t.Setenv("SCAN_CONTROL_PLANE_DEFAULT_DATASET_ALGO_NAME", "Custom Algo")
	t.Setenv("SCAN_CONTROL_PLANE_AGENT_BASE_URL", "http://agent.test")
	t.Setenv("SCAN_CONTROL_PLANE_LOCAL_FS_DEFAULT_AGENT_ID", "agent-default")
	t.Setenv("SCAN_CONTROL_PLANE_LOCAL_FS_PUBLIC_ROOT", "/host/root")
	t.Setenv("SCAN_CONTROL_PLANE_FEISHU_BASE_URL", "http://feishu.test")
	t.Setenv("SCAN_CONTROL_PLANE_AUTH_SERVICE_BASE_URL", "http://auth.test")
	t.Setenv("LAZYMIND_AUTH_SERVICE_INTERNAL_TOKEN", "internal-token")
	t.Setenv("SCAN_CONTROL_PLANE_TEMP_DIR", "/tmp/scan-control-plane-test")
