...
_REPRESENTATIVE_TOOL_ARGUMENTS: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': 'category/name',
...
_REPRESENTATIVE_TOOL_RESULTS: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': 'status',
...
_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': 'Updating reusable skill {value} now.',
...
_ZH_TOOL_CALL_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': '正在更新 {value} 技能。',
...
_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': 'Skill {value} was updated successfully.',
...
_ZH_TOOL_RESULT_PREVIEW_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': '已成功更新 {value} 技能。',
...
_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': 'Skill {value} could not be updated.',
...
_ZH_TOOL_RESULT_FAILURE_TEMPLATES: dict[str, str] = {
    ...
    'SkillEditorToolGroup_modify_skill': '未能更新 {value} 技能。',
